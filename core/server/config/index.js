...
_private.loadNconf = function loadNconf(options) {
    ...
    nconf.set('database:connection:host', process.env.DBHOST)
    nconf.set('database:connection:port', process.env.DBPORT)
    nconf.set('database:connection:user', process.env.DBUSER)
    nconf.set('database:connection:password', process.env.DBPASSWORD)
    nconf.set('database:connection:database', process.env.DBDATABASE)
